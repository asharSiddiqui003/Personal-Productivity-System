...
import { IoMailOutline, IoLockClosedOutline, IoArrowForwardOutline, IoPersonOutline } from "react-icons/io5";
...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Calls your server.js registration endpoint
      ...
      if (response.ok) {
        // Successfully registered! Redirect them to the Login page so they can sign in
        navigate('/login');
      } else {
