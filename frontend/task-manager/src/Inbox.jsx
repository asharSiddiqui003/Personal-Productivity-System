...
const Inbox = () => {
  ...
  return (
    <div className="relative left-80 top-0 h-screen w-[1120px] ">
      ...
      {isLoading ? (
        <div className="flex items-center justify-center text-4xl text-gray-500">Loading tasks...</div>
      ) : error ? (
        ...
        <div className="space-y-6">
          {activeTasks.map((task) => (
            ...
            >
              ...
              <p className="absolute left-[820px] top-[32px] text-2xl">{formatDate(task.created)}</p>
